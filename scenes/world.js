function setWorld(worldState) {
  ...
  player.onCollide("npc", () => {
    ...
    const dialogue = "Love save me from these monsters :("
    ...
    if (worldState.faintedMons < 4) {
      ...
      const content2 = dialogueBox.add([
        text("", {
          size: 15,
          width: 900,
          lineSpacing: 15,
      ...
      content2.text =
        "Happy Anniversary, my love! Every moment with you is a treasure. Your smile brightens my days, and your love warms my heart. Here's to many more years of laughter, love, and beautiful memories together. Love you always and forever. Always remember, no matter what i takes i will love you, biskan my mga arguments man ta or challenges i will keep choosing you. Wishing gid ko love nga malab ot ta aton individual dreams kag maging best person kita, i love you so much love HAPPY ANNIVERSARY <3 <3 <3"
    }
